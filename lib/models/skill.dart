...
final List<Skill> allSkills =[
  ...
  // ux ninja skills
  Skill(id: '13', name: 'Gamify', image: 'gamify.jpg', vocation: Vocation.yash),
  Skill(id: '14', name: 'Heat Map', image: 'h_map.jpg', vocation: Vocation.yash),
  Skill(id: '15', name: 'Wireframe', image: 'wireframe.jpg', vocation: Vocation.yash),
  Skill(id: '16', name: 'Dark Pattern', image: 'd_pattern.jpg', vocation: Vocation.yash),
];